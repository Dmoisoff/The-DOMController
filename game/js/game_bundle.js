  ...
  _createClass(Board, [{
    ...
    value: function placeMark(pos, mark) {
      if (!this.isEmptyPos(pos)) {
        throw new MoveError("Oops! The square you selected has already been taken. Please select a blank square to continue.");
      }
...
var View = function () {
  ...
  _createClass(View, [{
    ...
    value: function displayWin() {
      ...
      $l("span").append("<h2 class='restart'>Click here to play again <i class=\"far fa-smile-beam\"></i></h2>");
      $l(".restart").on("click", function () {
